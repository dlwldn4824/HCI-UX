...
Temi 실기 연동은 Android WebView APK(`android/`)에 올라간 React 앱 + `TemiInterface` 브리지로 동작합니다.
...
![기존 문제와 목표](docs/readme-assets/screens/14-problem.png)
...
![현장·사용성 테스트 결과 요약](docs/readme-assets/screens/13-eval-results.png)
...
![홈](docs/readme-assets/screens/01-home.png)

### 2막 — 안내 허브에서 지도·존·추천으로 분기한다

“어디로 데려다줄까?” — 전체 지도, 지능형로봇 존, 추천 장소로 갈라집니다.

![전시장 안내 허브](docs/readme-assets/screens/02-guide-hub.png)
...
![전시장 지도 · TrainNav](docs/readme-assets/screens/03-map-trainnav.png)

![길 안내 중](docs/readme-assets/screens/04-temi-guide.png)

### 4막 — 조건으로 추천하고, 결과에서 다시 이동한다

연령·체류 시간·신청 방식으로 걸러 추천한 뒤, 존 상세에서 곧바로 길 안내로 이어집니다.

![추천 검색 필터](docs/readme-assets/screens/05-recommend-filter.png)

![추천 결과](docs/readme-assets/screens/06-recommend-result.png)

### 5막 — QR로 줄 서고, 같은 화면에서 길 안내를 받는다

지능형로봇 존 8개 체험 프로그램별 QR. 스캔 후 **길 안내 받기**로 동선이 끊기지 않게 했습니다.

![현장 줄서기](docs/readme-assets/screens/07-line-qr.png)

![체험 상세 · QR](docs/readme-assets/screens/08-line-detail.png)

### 6막 — 일정·이벤트로 참여를 닫는다

경진대회 목록·상세, 추첨용 전화 입력까지 한 앱 안에서 이어집니다. (전화번호는 추첨용·사용 후 폐기 안내)

![경진대회 일정](docs/readme-assets/screens/09-schedule.png)

![일정 상세](docs/readme-assets/screens/10-schedule-detail.png)

![이벤트 · 전화 입력](docs/readme-assets/screens/11-event-phone.png)
...
![소프트웨어 아키텍처](docs/readme-assets/screens/12-architecture.png)
...
![결론 슬라이드](docs/readme-assets/screens/15-conclusion.png)
...
└── docs/readme-assets/screens # 최종보고서·발표에서 발췌한 화면
```
